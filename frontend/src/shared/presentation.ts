...
const stateTranslationKeyMap: Record<string, string> = {
  ...
  created: "common.states.created",
  purchased: "common.states.purchased",
  reserved: "common.states.reserved",
  expired: "common.states.expired",
  failed: "common.states.failed",
  pending: "common.states.pending",
  pending_payment: "common.states.pendingPayment",
  payment_failed: "common.states.paymentFailed",
  payment_cancelled: "common.states.paymentCancelled",
  requires_action: "common.states.requiresAction",
  succeeded: "common.states.succeeded",
  refunded: "common.states.refunded",
  partially_refunded: "common.states.partiallyRefunded",
